...
public class MapsExmample {
    ...
    nombreMap.isEmpty(); // Devuelve public si no hay elementos en el Map y false si si los hay
    ...
    nombreMap.containsKey(K clave); // Devuelve public si en el map hay una clave que coincide con K
    nombreMap.containsValue(V valor); // Devuelve public si en el map hay un Valor que coincide con V
